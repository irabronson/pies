...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Pies &mdash; Bad Request</title>
  ...
  <body>
      ...
      <main class="page-container animate-in step-3">
        ...
        <section class="page-section error-page">
          <h3>Bad Request</h3>
          <p class="secondary">Error 400</p>
          <p>Ugh, your browser sent a request the server can't understand. I don't know what that means either, but you can <a href="/">see many many prototypes here</a>.</p>
