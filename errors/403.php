...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Pies &mdash; Forbidden</title>
  ...
  <body>
      ...
      <main class="page-container animate-in step-3">
        ...
        <section class="page-section error-page">
          <h3>Forbidden</h3>
          <p class="secondary">Error 403</p>
          <p>No permission 4 u. Go away. Well, don't go all the way away. You can <a href="/">see many many prototypes here</a>.</p>
