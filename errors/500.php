...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Pies &mdash; Internal Server Error</title>
  ...
  <body>
      ...
      <main class="page-container animate-in step-3">
        ...
        <section class="page-section error-page">
          ...
          <p class="secondary">Error 500</p>
          <p>Something got fucked up. It's as indescribable as how Riki Rachtman made it out of the MTV studio alive every night. Say "Poison sucks" and try again to <a href="/">see many many prototypes here</a>.</p>
