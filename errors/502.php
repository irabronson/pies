...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Pies &mdash; Bad Gateway</title>
  ...
  <body>
      ...
      <main class="page-container animate-in step-3">
        ...
        <section class="page-section error-page">
          <h3>Bad Gateway</h3>
          <p class="secondary">Error 502</p>
          <p>Apparently, some server had to talk to another server and that other server is an asshole. It may be futile trying to <a href="/">see many many prototypes here</a>, but I thought the same thing when I bought two raffle tickets one day in middle school, only to win both the Van Halen tape AND the 3-foot stuffed parrot (which I later humped out of curiosity).</p>
