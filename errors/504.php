...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Pies &mdash; Gateway Time-Out</title>
  ...
  <body>
      ...
      <main class="page-container animate-in step-3">
        ...
        <section class="page-section error-page">
          <h3>Gateway Time-Out</h3>
          <p class="secondary">Error 504</p>
          <p>Just like the asshole server behind the 502/Bad Gateway, this is tantamount to an irresponsible obnoxious citizen that inflicts their self-indulgent impulsions on the rest of us. Someone that says they've overnighted an important document when they know they haven't. The server is slow or totally down, but you can <a href="/">see many many prototypes here</a>.</p>
